...
class RemoteDataSource private constructor(private val apiSevice: ApiSevice) {
    companion object {
        @Volatile
        private var instance: RemoteDataSource? = null

        fun getInstance(service: ApiSevice): RemoteDataSource =
